    ...
    <div class="top">
        <div class="block left">
            ...
            <ul>
                ...
                <li><a target="_blank" href="http://www.hkcms.cn/">HKCms社区</a></li>
                <li><a target="_blank" href="http://www.hkcms.cn/">HKCms手册</a></li>
            </ul>
        </div>
        <div class="block center">
            ...
            <ul>
                ...
                {volist name="data" di="vo"}
                <li><a href="{$vo['url']}">{$vo['catname]'}</a>{if cindition="$key<(count($data)-1")&nbsp{/if}</li>
                {/volist}
                {/hkcms:content}
